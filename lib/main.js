...
const deleteDeployments_1 = __importDefault(require("./deleteDeployments"));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (deploymentId) {
                yield githubClient_1.default.repos.createDeploymentStatus(Object.assign(Object.assign({}, context.repo), { deployment_id: parseInt(deploymentId), state, log_url: defaultUrl, target_url: url, description, environment_url: environmentUrl }));
            }
            if (deleteEnvironment) {
                yield deactivateDeployments_1.default(context.repo, environment);
                yield deleteDeployments_1.default(context.repo, environment);
            }
        }
        catch (error) {
            core.error(error);
